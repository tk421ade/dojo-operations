...
class SubscriptionProductAdmin(DojoFkFilterModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        extra_context['documentation'] = \
            f"""<b>help</b>: 
            Subscription Product defines the amount and frequency of the payments 
            ...
            <a href="{reverse('admin:financial_subscription_changelist')}">subscribe</a> to a dojo. 
            """
...
class SubscriptionAdmin(DojoFkFilterModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        extra_context['documentation'] = \
            f"""<b>help</b>: 
            Subscription is a membership agreement between a <a href="{reverse('admin:shodan_student_changelist')}">student</a> and dojo, 
            defined by the <a href="{reverse('admin:financial_subscriptionproduct_changelist')}">subscription product</a>,
...
class SaleAdmin(DojoFkFilterModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        extra_context['documentation'] = \
            ...
            <a href="{reverse('admin:financial_subscription_changelist')}">subscriptions</a>, as well as other items 
            required to run <a href="{reverse('admin:shodan_session_changelist')}">sessions</a>. 
            You can automatically generate sales from subscriptions by clicking the button "Update Sales From Subscriptions". \
            Additionally, <a href="{reverse('admin:shodan_student_changelist')}">students</a> will be reminded when their 
            <a href="{reverse('admin:financial_subscription_changelist')}">subscription</a> expires when they register
